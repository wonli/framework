...
function pageInit()
{
	...
	var fulltools = 'Cut,Copy,Paste,|,Fontface,FontSize,Bold,Italic,Underline,Strikethrough,|,FontColor,BackColor,Align,List,Outdent,Indent,|,Link,Unlink,|,tsAttach,tsImg,tsMusic,Flash,tsVideo,Emot,tsCode,|Fullscreen';
	var minitools = 'Fontface,Bold,FontColor,Link,Unlink,|,tsAttach,tsImg,tsMusic,Flash,tsVideo,Emot,tsCode,|Fullscreen';
