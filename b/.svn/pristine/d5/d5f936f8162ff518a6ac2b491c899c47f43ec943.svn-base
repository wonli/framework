...
class MySql {
	...
	function __construct()
	{
		...
		try{
			$this->db = new pdo($dsn,Config::$dbuser,Config::$dbpass,array(PDO::ATTR_PERSISTENT => true));//持久链接
	...
	*/
		...
		<table cellpadding="10" cellspacing="0" border="0" width="100%" align="left" style="font-family: Verdana, Tahoma; color: #666666; font-size: 12px;border:1px solid #F00">
		  <tr>
		    <td valign="middle" align="left" bgcolor="#EBEBEB"><br>
		      ...
		      <br>出现了致命错误。导致网站非正常停止响应，您应该尽快的将本错误告知网站技术支持人员。技术支持QQ:8879244
		      <p>
	...
	{
		$path =  STATIC_PATH.'log'.DS.'db_log.txt';
		if(!file_exists($path)){
